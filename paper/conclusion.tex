...
\begin{itemize}[leftmargin=*, nosep]
	...
	\item
	\Citeauthor{on_optimal_tradeoffs_between_efx_and_nsw}~\cite{on_optimal_tradeoffs_between_efx_and_nsw} show a \(\frac{1}{\alpha + 1}\)-approximative algorithm computing allocations which are \(\alpha\)-\EFX{} for the symmetric additive \NSW{} with \(\alpha \in [0, 1]\).
...
\end{itemize}
As seen, the research on the \NSW{} gained pace in the last years, and some points raised by \citeauthor{APNSWuSVþUM} have been addressed.
