\def\af{\frac{\euler}{\raisebox{0.35ex}{\(\scriptstyle\euler - 1\)}}}
...
\begin{theorem}
	The submodular \NSW{} is not approximable within a factor of \(\af\) in polynomial time unless \(\P = \NP\), even when the agents have equal weights and valuation functions.
\end{theorem}
\begin{proof}
