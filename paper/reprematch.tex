...
\begin{algorithm*}[!b]
	...
	\phaseiiisep
	\(\goodsrem \gets \mathop{\bigcup\hspace{-1pt}_{i \in \agents}} \alloc[\phasei]\)  \tct*{bring back items assigned in phase~\phasei} \label{ln:goodsrem}
	\(\weights \gets \{\,  \weight \cdot \log\paren[\big]{ \valuations[ \alloc[\phaseii] \cup \{j\} ] } \given[\bigm] i \in \agents, j \in \goodsrem \,\}\)   \tct*{val. of item \& cur. bundle}
...
The edge weights reflect this by taking only the valuations of single items into account.
