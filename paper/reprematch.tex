...
\end{lemma}
\begin{proof}
	If in phase~\phasei{} all items were matched, \ie, \(\goodsrem = \emptyset\), then the optimal item \(\asgd*{1}\) of each agent \(i\) is released in phase~\phaseiii{} and can be assigned to her;
