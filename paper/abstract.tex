\begin{abstract}
	...
	Furthermore, we prove that the \NSW{} under submodular valuation functions cannot be approximated within a factor of \(\frac{\euler}{\euler - 1}\), even when not asymmetric.
\end{abstract}