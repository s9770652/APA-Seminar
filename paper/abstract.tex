\begin{abstract}
	...
	More specifically, the algorithms have approximation factors of \(\bigomicron{n}\) and \(\bigomicron{n \log n}\) for the asymmetric \NSW{} under additive and submodular valuation functions, respectively, where \(n\) is the number of recipients.
