...
\begin{figure*}
	...
	\end{subfigure}
	\caption{%
		Illustration of \cref{ex:bad_idea} with \(m+1\) items and two equally weighted agents, their valuations shown as edge weights.
...
\begin{equation}
	...
	= \valuations[ \goodsordered{2n+1}, \dots, \goodsordered{m} ] \mperiod
\end{equation}
...
\begin{proof}
	...
	\begin{equation}
		...
		= \frac{\remvalue}{n} \label{eq:lower_bound_later_items} \mperiod
	\end{equation}
\end{proof}
