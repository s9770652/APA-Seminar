...
The geometric mean of the \NSW{} favours allocations with similarly valued bundles\todo{stimmt das?}, wherefore it may be beneficial for an agent to leave items to other agents if those agents cannot expect many more valuable items in the future.
