...
\begin{figure*}
	...
	\end{subfigure}
	\caption{%
		An example showing that simple repeated matching without consideration of the future leads to an approximation factor dependent on the number \(m\) of items.
...
\todo[inline]{tightness}
\todo[inline]{envy-freeness?}