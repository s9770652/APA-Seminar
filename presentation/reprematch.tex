	...
	\begin{columns}[T, onlytextwidth]
		...
		\begin{column}{0.45\textwidth}
			...
			\begin{tikzpicture}[val/.style = {font={\small\boldmath}, sloped, above}, match/.style = {}, match3/.style = {}]
				...
				\node<2-3|handout:0> at (       4, 0) (i6) {\includegraphics[height=6mm]{img/naive_item}};
				\node<4- |handout:1> at (-0.65, 5)      {\includegraphics[height=6mm]{img/naive_item}};
				\node<4- |handout:1> at (-0.65, 0)      {\includegraphics[height=6mm]{img/naive_item}};
				...
				% Items (third batch)
				\node<5-8|handout:1> at ( 4.00, 1) (i5) {\includegraphics[height=6mm]{img/naive_item}};
				\node<5-8|handout:1> at ( 4.00, 3) (i3) {\includegraphics[height=6mm]{img/naive_item}};
				\node<9- |handout:0> at (-1.95, 5) (i5) {\includegraphics[height=6mm]{img/naive_item}};
				\node<9- |handout:0> at (-1.95, 0) (i3) {\includegraphics[height=6mm]{img/naive_item}};
				...
				% Dilators.
				\node<2->[opacity=0] at (-1.950, 5)       {\includegraphics[height=6mm]{img/naive_item}};
	...
	\begin{columns}[T]
		...
		\begin{column}{0.375\textwidth}
			...
			\begin{tikzpicture}[lbl/.style = {font={\Large\boldmath}}]
				...
				% Items (planks).
				\node<5- 9|handout:0> at (3, 4) {\includegraphics[height=8mm]{img/outstanding_itemplanks}};
				\node<5-11|handout:0> at (3, 3) {\includegraphics[height=8mm]{img/outstanding_itemplanks}};
				\node<5-10|handout:0> at (3, 2) {\includegraphics[height=8mm]{img/outstanding_itemplanks}};
				\node<5- 8|handout:0> at (3, 1) {\includegraphics[height=8mm]{img/outstanding_itemplanks}};
...
\begin{frame}{Analysing Phase \phaseii{} (2/2)}
	...
	\begin{lemma}
		...
		\begin{flalign*}
			...
			\onslide*<44   |handout:0>{- \!\!\sum_{l=2}^{r} (n-1) \cdot \valuations[ \asgd{l-1} \given \asgd{1}, \dots, \asgd{l-2} ][\big] }
