...
\begin{frame}{Analysing Phase \phaseii{} (2/2)}
	...
	\begin{lemma}<2->
		...
		\begin{flalign*}
			...
			\temporal<19-24>{}{=}{\ge}
			\onslide*<19-20>{\valuations[ \attopt{r} \cup \braces[\big]{\asgd{1}, \dots, \asgd{r-1}} ][\big] \alert<20>{- \valuations[\asgd{1}, \dots, \asgd{r-1}][\big]}}
			\onslide*<21-  >{- \valuations[\asgd{1}, \dots, \asgd{r-1}][\big] +}
			\onslide*<21-24>{\valuations[ \attopt{r} \cup \braces[\big]{\asgd{1}, \dots, \asgd{r-1}} ][\big]}
	...
	\begin{figure}
		\hspace{-3em}
		\begin{tikzpicture}
			\node<  - 2>[minimum height=45mm] {};  % prevents wobbling of lemma block in otherwise empty page
