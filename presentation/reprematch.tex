	...
	\begin{columns}[t, onlytextwidth]
		...
		\begin{column}{0.4\textwidth}
			...
			\begin{tikzpicture}[
				...
				\node[opacity=0] at (-1.6, 3.8) (inv1) {\includegraphics[height=6mm]{img/naive_itemtemp}};
				\node[opacity=0] at (-1.6, 0.7) (inv2) {\includegraphics[height=6mm]{img/naive_itemtemp}};

				\path[fix, opacity=0] (inv2) edge (inv1);
			\end{tikzpicture}
		\end{column}
	\end{columns}
\end{frame}
